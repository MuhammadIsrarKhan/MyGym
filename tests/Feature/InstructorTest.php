...
{
    // use RefreshDatabase;
    public function test_istructor_is_redirected_to_instructor_dashboard()
    {
        ...
        $this->followRedirects($response)->assertSeeText("Hay instructor");
    }
